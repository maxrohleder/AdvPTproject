  ...
  public:
    ...
    void optimize(bool sort = true)
    {
        ...
        if (analytics)
        {
            ...
            analyticsfile << "using seed: " << seed << endl;
            analyticsfile << "ep: " << epochs << " it: " << iterations_per_epoch << " nc: " << number_to_create_to << " nb: " << number_best << "nm: " << number_to_mutate_to << endl;
        }
        int stagnation = 0;
        int best_runtime = -1;
